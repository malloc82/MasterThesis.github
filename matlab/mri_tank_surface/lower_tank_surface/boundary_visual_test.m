function boundary_visual_test(coronal_set, sagittal_set)
    ...
    function [left_bounds, right_bounds] = get_surface_boundaries(image_set)
    % mid_sample_index = 110;
        ...
        function [left_bounds right_bounds] = surface_edge(upper_layer, lower_layer, plot_data, msg)
            ...
            [left right mid_boundary_info] = ...
                find_surface_boundary(region, [], plot_data, strcat(msg, '_mid'));
            ...
            % radius = int32(length(image_set) / 2) - 2 ;
    ...
    if ~isempty(sagittal_right)
        scatter3(sagittal_right(:, 1), sagittal_right(:, 2), sagittal_right(:, 3), 'r'); 
    end
