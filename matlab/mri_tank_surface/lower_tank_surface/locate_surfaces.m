function  tank_surfaces = locate_surfaces(image_data)
    ...
    tank_surfaces = struct('exterior_outside_upper', filtered_maxpeaks(1,1)-10, ...
                           ...
                           'exterior_outside_mid',   filtered_maxpeaks(1,1), ...
                           'exterior_inside_upper',  filtered_minpeaks(1,1)-10, ...
                           'exterior_inside_lower',  filtered_minpeaks(1,1)+15, ...
                           'exterior_inside_mid',    filtered_minpeaks(1,1), ...
                           'inferior_outside_upper', filtered_maxpeaks(end,1)-15, ...
                           'inferior_outside_lower', filtered_maxpeaks(end,1)+10, ...
                           'inferior_outside_mid',   filtered_maxpeaks(end,1), ...
                           'inferior_inside_upper',  filtered_minpeaks(end,1)-10, ...
                           'inferior_inside_lower',  filtered_minpeaks(end,1)+20, ...
                           'inferior_inside_mid',    filtered_minpeaks(end,1), ...
