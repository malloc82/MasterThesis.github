function [S1 S2 S3 S4] = get_mri_tank_surfaces(data_set_dir, image_file)
% inputs : 
...
%         Second argument: for testing purpose, could be omitted
    ...
    if nargin == 1
        ...
        mid_image = dicomread(sprintf('%s/%s', '../../data/nov_18_test_2', '20121118_112.dcm'));
        newfigure('original mid slice');
        imshow(mid_image, []);

        im_info1 = dicominfo(sprintf('%s/%s', '../../data/nov_18_test_2', '20121118_111.dcm'));
        im_info2 = dicominfo(sprintf('%s/%s', '../../data/nov_18_test_2', '20121118_113.dcm'));
